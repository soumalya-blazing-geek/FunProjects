...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(option, "plus") == 0) {
            ...
            float plus_1, plus_2;
            while (1) {
                printf("\n [o] Enter the first number to plus: ");
                if (scanf("%f", &plus_1) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            while (1) {
                printf(" [o] Enter the second number to plus: ");
            ...
            while (1) {
                printf("\n [o] Enter the first number to minus: ");
                if (scanf("%f", &minus_1) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            while (1) {
                printf(" [o] Enter the second number to minus: ");
            ...
            while (1) {
                printf(" [o] Enter the second number to multiply: ");
            ...
            float div_1, div_2;
            while (1) {
                printf("\n [o] Enter the first number to division: ");
                if (scanf("%f", &div_1) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            while (1) {
                printf(" [o] Enter the second number to division: ");
            ...
            float num;
            while (1) {
                printf("\n [o] Enter a number to find its square: ");
            ...
            float num;
            while (1) {
                printf("\n [o] Enter a number to find its cube: ");
                if (scanf("%f", &num) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            ...
            float num;
            while (1) {
                printf("\n [o] Enter a number to find its square root: ");
                if (scanf("%f", &num) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            ...
            float num;
            while (1) {
                printf("\n [o] Enter a number to find its cube root: ");
                if (scanf("%f", &num) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            ...
            while (1) {
                printf("\n [o] Enter the principal amount: ");
                if (scanf("%f", &principal) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            while (1) {
                printf(" [o] Enter the interest rate: ");
                if (scanf("%f", &rate) == 1) break;
                printf(" [x] ERROR: Please Enter a number value!\n");
                while (getchar() != '\n'); // Clear the input buffer
            }
            while (1) {
                printf(" [o] Enter the time (in years): ");
            ...
            while (1) {
                ...
                if (scanf("%d", &day) == 1 && day >= 1 && day <= 31) {
                    ...
                    printf(" [x] ERROR: Please enter a valid day!\n");
                    while (getchar() != '\n'); // Clear input buffer
                }
            }
            while (1) {
                printf(" [o] Enter the month: ");
                if (scanf("%d", &month) == 1 && month >= 1 && month <= 12) {
                    break;
                } else {
                    printf(" [x] ERROR: Please enter a valid month!\n");
                    while (getchar() != '\n'); // Clear input buffer
                }
            }
            while (1) {
                printf(" [o] Enter the year: ");
                if (scanf("%d", &year) == 1 && year >= 1) {
                    break;
                } else {
                    printf(" [x] ERROR: Please enter a valid year!\n");
                    while (getchar() != '\n'); // Clear input buffer
                }
            }
            ...
            int table;
            while (1) {
                printf("\n [o] Enter the number for multiplication table: ");
                if (scanf("%d", &table) == 1) {
                    break;
                } else {
                    printf(" [x] ERROR: Please enter a valid number!\n");
